            ...
            <div class="col-lg-10 col-lg-offset-1">
                <article class="hentry post post-standard-details">
                    ...
                    <div class="post-thumb">
                        <img src="{{$post->featured}}" alt="{{$post->title}}" width="810" height="450">
                    </div>
                    ...
                    @if($prev)
                        <a href="{{route('post.single',['slug' => $prev->slug ])}}" class="btn-next-wrap">
                            <div class="btn-content">
                                ...
                                <p class="btn-content-subtitle">{{substr($prev->title,0,30)}}...</p>
                            </div>
                            <svg class="btn-next">
                    ...
                    @if($next)
                        <a href="{{route('post.single',['slug' => $next->slug ])}}" class="btn-prev-wrap">
                            ...
                            <div class="btn-content">
                                ...
                                <p class="btn-content-subtitle">{{substr($next->title,0,30)}}...</p>
                            </div>
                        </a>
                    @endif
                </div>
